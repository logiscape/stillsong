...
export function Panel({ children, variant = 'matte', pad = 'var(--gutter-panel)', style }: PanelProps): React.ReactElement {
  ...
  return <div style={{ borderRadius: 'var(--radius-lg)', padding: pad, ...skin, ...style }}>{children}</div>;
}
