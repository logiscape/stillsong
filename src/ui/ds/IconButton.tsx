...
export function IconButton({ icon, label, size = 40, iconSize, variant = 'ghost', active, onClick, style }: IconButtonProps): React.ReactElement {
  ...
  return (
    <button
      ...
      style={{
        ...
        ...skin, ...(active ? { color: 'var(--brass-200)' } : null), ...style,
      }}
    >
